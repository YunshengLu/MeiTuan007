...
`;function ie(){return u(re,{children:u("div",{className:"search-content",children:S("div",{className:"search-content-box",children:[u("nav",{className:"search-content-nav",children:"\u70ED\u95E8\u641C\u7D22"}),S("section",{className:"search-content-link",children:[u("a",{className:"search-content-hots",children:"\u70E7\u70E4"}),u("a",{className:"search-content-hots",children:"\u997A\u5B50"}),u("a",{className:"search-content-hots",children:"\u5976\u8336"}),u("a",{className:"search-content-hots",children:"\u53E4\u8317"}),u("a",{className:"search-content-hots",children:"\u70B8\u9E21"}),u("a",{className:"search-content-hots",children:"\u9EBB\u8FA3\u70EB"}),u("a",{className:"search-content-hots",children:"\u87BA\u72EE\u7C89"}),u("a",{className:"search-content-hots",children:"\u4E00\u70B9\u70B9"}),u("a",{className:"search-content-hots",children:"\u534E\u83B1\u58EB"}),u("a",{className:"search-content-hots",children:"\u53E4\u8317\u5976\u8336"}),u("a",{className:"search-content-hots",children:"\u871C\u96EA\u51B0\u57CE"}),u("a",{className:"search-content-hots",children:"\u8336\u767E\u9053"}),u("a",{className:"search-content-hots",children:"\u6B63\u65B0\u9E21\u6392"}),u("a",{className:"search-content-hots",children:"\u80AF\u5FB7\u57FA"}),u("a",{className:"search-content-hots",children:"\u9EA6\u5F53\u52B3"})]})]})})})}N.div`
    position: fixed;
    left: 0;
    right: 0;
    bottom: 0;
...
`;const ce=n=>{const i=Q(),[l,e]=d.exports.useState("\u5468\u6770\u4F26"),[s,t]=d.exports.useState(!0);return d.exports.useEffect(()=>{},[]),u(J,{in:s,timeout:1e3,appear:!0,classNames:"fly",unmountOnExit:!0,onExit:()=>{i("/")},children:u(oe,{children:S("div",{className:"search_box_wrapper",children:[u(ae,{back:()=>{t(!1)},newQuery:l,handleQuery:o=>{e(o)}}),u(ie,{})]})})})},le=n=>({enterLoading:n.search.enterLoading}),ue=n=>({changeEnterLoadingDispatch(i){n(W(i))}});var he=I(le,ue)(d.exports.memo(ce));export{he as default};
